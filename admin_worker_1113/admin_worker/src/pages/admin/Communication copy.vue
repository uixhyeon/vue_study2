        ...
        <div class="p-6 border-t bg-white">
          <div class="flex flex-col md:flex-row md:items-center gap-3">
            ...
            <div class="flex flex-wrap gap-2">
              <button class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">빠른 답변</button>
              <button   class="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">전송</button>
              <button class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">답변 완료</button>
            </div>
          </div>
        </div>
      </div>
...
//새로운 메세지를 추가할 때 ID값을 증가 시키기 위해서
