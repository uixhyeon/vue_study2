        ...
        <table class="w-full">
          ...
          <tbody class="bg-white dark:bg-gray-800 dark:text-white">
            <tr
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:bg-gray-800 dark:text-white">
                {{ formatDate(conversation.startDate) }}
              </td>
              <td class="px-6 py-4 whitespace-nowrap dark:bg-gray-800 dark:text-white">
                <div class="flex items-center">
                  <p
                    :class="[
                      'w-10 h-10 rounded-full flex items-center justify-center text-white font-bold dark:bg-gray-800 dark:text-white',
                      getCustomerAvatarBg(conversation.customerName),
                    ]">
                    {{ conversation.customerName[0] }}
                  </p>

                  <span class="ml-3 text-sm text-gray-900dark:bg-gray-800 dark:text-white ">{{ conversation.customerName }}</span>
                </div>
              </td>
              <td class="px-6 py-4 text-sm text-gray-900 max-w-xsdark:bg-gray-800 dark:text-white dark:bg-gray-800 dark:text-white">
                <div class="flex items-center">
                  <span>{{ conversation.lastMessage }}</span>
                  <span
                    class="ml-2 bg-red-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center dark:bg-gray-800 dark:text-white"
              ...
              <td class="px-6 py-4 whitespace-nowrap dark:bg-gray-800 dark:text-white">
                <span
                  :class="[
                    'px-2 py-1 text-xs font-medium rounded-full dark:bg-gray-800 dark:text-white',
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium dark:bg-gray-800 dark:text-white">
